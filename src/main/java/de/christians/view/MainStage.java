...
public class MainStage extends Stage {
    ...
    private final Button newT, openT, saveT, compileT, gridT, eMitET, turnT, stepT, takeT,
    ...
    public MainStage(Territorium ter){
        ...
        territoriumPane = new TerritoriumPane(ter);
        ...
        openT = new Button();
        openT.setGraphic(loadImageView);
        openT.setTooltip(new Tooltip("Laden"));
        saveT = new Button();
        ...
        ToolBar toolbar = new ToolBar(
                newT, openT, new Separator(), saveT, compileT, new Separator(), gridT, eleT, peanutT, mouseT, deleteT, new Separator(), eMitET, turnT, stepT, takeT, dropT, new Separator(), playT, pauseT, stopT
        );
        ...
        pane.getItems().addAll(textArea, scPane);
        VBox vbox = new VBox();
